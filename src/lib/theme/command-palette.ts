...
export default (options: Required<ModuleOptions>) => ({
	slots: {
		...
		footer: 'p-1',
		viewport:
			'relative divide-y divide-default scroll-py-1 overflow-y-auto flex-1 focus:outline-none',
		group: 'p-1 isolate',
		...
		itemTrailingHighlightedIcon:
			'shrink-0 size-5 text-dimmed hidden group-data-highlighted:inline-flex',
