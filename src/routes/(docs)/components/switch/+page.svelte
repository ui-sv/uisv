<script lang="ts">
	...
	import { Switch, type SwitchProps, Button } from '$lib/index.js';
...
<div class="space-y-4 p-4">
	...
	<h1>Loading</h1>
	{@render components({ loading: true })}

	<p>Custom icon</p>
	{@render components({ loading: true, loadingicon: 'i-lucide-loader' })}
